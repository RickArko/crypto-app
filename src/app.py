...
from coingecko import get_cg_daily_ohlc
...
from visualize import get_gecko_logo, plotly_main_plot

# from model_prophet import make_forecast_df
...
def set_app_layout_and_return_text_input():
    ...
    Example:
        - bitcoin, ethereum, chainlink, etc.
        - sym:btc, sym:eth, sym:link, etc.
    """
